function [fval,dummy] = objFunWMOSS(X,varargin)
global archive fvals objFunOptions suREL suRED ix_solutions
% objective function for developing WMOSS wrappers
%
%
%
